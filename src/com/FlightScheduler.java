                ...
                switch (s1[0].toLowerCase()){
                    ...
                    case "help":
                        System.out.println(
                            ...
                            "If no number is given, book 1 passenger. If the given number of bookings is more than the remaining capacity, only accept bookings until the capacity is full.\n" +
